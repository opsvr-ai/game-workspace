...
- **店长可以看到所有客服的派单记录（2026-09-24）:** 派单工作台底部那块面板以前一律按「发布人 = 自己」过滤，店长站在自己页面上只能看到自己发的单，客服发的全看不见（线上蠢驴电竞：店长 31 条、客服邵泽慧 63 条，那 63 条店长一条看不到）。现在店长看本店、老板看全部的「客服派单记录（N）」，每行带 📋发布人，右上角可按客服筛一个人；一次最多铺 100 行，更多去「订单管理 → 全部订单」。管理端订单表也加了「客服筛选」（店长/老板可见，带岗位前缀，如「客服 邵泽慧」），选一个就只看她派的单。客服自己那边不变，仍是「我发布的订单」。
