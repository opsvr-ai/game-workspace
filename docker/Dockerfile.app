...
RUN apt-get update \
 ...
 && pip3 install --no-cache-dir --break-system-packages --upgrade impacket \
 && wget -q https://raw.githubusercontent.com/fortra/impacket/master/examples/psexec.py -O /usr/local/bin/psexec.py \
